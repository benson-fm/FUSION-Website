          ...
          <div className="flex flex-col justify-center items-center gap-20 py-40">
            <div className="w-1/2 flex flex-col items-center justify-center gap-10">
              ...
              <p className="text-4xl font-bold text-center">
                An education community brimming with{" "}
                <span className="text-[#FFA523]">Filipino culture.</span>
              </p>
            ...
            <div className="flex flex-row items-center justify-center gap-20 z-50">
              <div className="flex flex-col items-center justify-evenly w-1/6 h-[400px] bg-white rounded-tl-3xl">
                ...
                <p className="text-center px-5">
                  The Pilipinx Pre-health Undergraduate Student Organization
                  (PUSO) focuses on pre-health and pre-medical career paths for
                  the Filipinx community.
                </p>
                <div className="bg-[#FFA523] w-1/2 h-10 items-center justify-center flex">
                  <a href="https://www.instagram.com/pusoatuci/">
                    {" "}
              ...
              <div className="flex flex-col items-center justify-evenly w-1/6  h-[400px] bg-white">
                ...
                <p className="text-center px-5">
                  Kababayan (KABA) is one of the largest collegiate
                  Pilipinx-American organizations in California and nationwide,
                  focusing on Filipino culture.
                </p>
                <div className="bg-[#FFA523] w-1/2 h-10 items-center justify-center flex">
                  <a href="https://www.instagram.com/kabaatuci/">
                    <p className="text-center text-white font-medium">
                      LEARN MORE
                    </p>
                  </a>
              ...
              <div className="flex flex-col items-center justify-evenly w-1/6  h-[400px] bg-white rounded-br-3xl">
                ...
                <p className="text-center px-5">
                  Pilipinx-Americans in Social Studies (PASS) is an organization
                  that focuses on fields relating to law, humanities, social
                  sciences, and social ecology.
                </p>
                <div className="bg-[#FFA523] w-1/2 h-10 items-center justify-center flex">
                  <a href="https://www.instagram.com/passatuci/">
                    <p className="text-center text-white font-medium">
                      LEARN MORE
                    </p>
                  </a>
